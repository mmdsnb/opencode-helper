...
> **Tip**: We tested a select group of models and talked to their teams about how to best run them.
...
The [model id](/docs/config/#models) in your OpenCode config uses the format `opencode/<model-id>`. For example, for GPT 5.3 Codex, you would use `opencode/gpt-5.3-codex` in your config.
